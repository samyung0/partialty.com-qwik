...
export default component$(() => {
  ...
  return (
    <>
      <section class="flex min-h-[100dvh] min-h-[100vh] flex-col bg-background-light-gray dark:bg-primary-dark-gray dark:text-background-light-gray">
        <div class="flex max-h-[100dvh] max-h-[100vh] flex-1 flex-col lg:flex-row">
          <nav class="hidden max-h-[100dvh] max-h-[100vh] min-h-full w-[20%] min-w-[300px] max-w-[500px] overflow-auto bg-pale-yellow/50 pl-6 pr-6 dark:bg-disabled-dark lg:block lg:w-[30%] 2xl:pl-[10%]">
