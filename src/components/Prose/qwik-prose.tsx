...
export default component$(({ innerHTML }: { innerHTML: string }) => {
  return (
    <section
      ...
      id="sectionProse"
      class="prose w-full max-w-[800px] bg-background-light-gray px-6 py-6 text-base prose-a:decoration-wavy
    ...
    md:px-10 md:py-12 lg:text-lg 2xl:ml-[10%] mx-auto 2xl:mx-0"
