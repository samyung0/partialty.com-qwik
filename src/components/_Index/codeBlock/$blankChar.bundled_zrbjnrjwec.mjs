...
Array.from(code).forEach((char) => {
  if (char === "\n")
    ...
    _astroCodeBlankChar[_astroCodeBlankChar.length - 1]++;
});
...
Array.from(code2).forEach((char) => {
  if (char === "\n")
    ...
    _qwikCodeBlankChar[_qwikCodeBlankChar.length - 1]++;
});
...
Array.from(code3).forEach((char) => {
  if (char === "\n")
    ...
    _reactCodeBlankChar[_reactCodeBlankChar.length - 1]++;
});
...
Array.from(code4).forEach((char) => {
  if (char === "\n")
    ...
    _reactCode2BlankChar[_reactCode2BlankChar.length - 1]++;
});
