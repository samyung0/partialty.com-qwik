...
const texts = [
  <p key="text1" class={'text-base md:tracking-wide lg:text-lg lg:leading-[2rem] 2xl:text-xl 2xl:leading-[2.5rem]'}>
    <strong>React</strong> is a JavaScript framework that helps build{' '}
    <span class="border-b-4 border-bright-yellow 2xl:border-b-8">interactive and reusable user interfaces</span>. It
  ...
  <p key="text2" class="text-base md:tracking-wide lg:text-lg lg:leading-[2rem] 2xl:text-xl 2xl:leading-[2.5rem]">
  ...
  <p key="text3" class="text-base md:tracking-wide lg:text-lg lg:leading-[2rem] 2xl:text-xl 2xl:leading-[2.5rem]">
    <strong>Astro</strong> is a framework that enables developers to build websites using a mix of{' '}
    <span class="border-b-4 border-lilac 2xl:border-b-8">static and dynamic</span> content. It allows for faster
...
export default component$(() => {
  ...
  return (
    <section class="min-h-[100vh] bg-lilac py-8">
      <div class="flex min-h-[100vh] flex-col items-center justify-center gap-24">
        ...
        <div class="relative flex items-start">
          <div class="h-[300px] w-[500px] max-w-[90vw] lg:h-[350px] lg:w-[800px] 2xl:h-[400px] 2xl:w-[900px]">
            <div class="absolute h-[300px] w-[500px] max-w-[90vw] -translate-x-3 -translate-y-3 rounded-lg border-2 border-black bg-rose lg:h-[350px] lg:w-[800px] lg:-translate-x-6 lg:-translate-y-4 2xl:h-[400px] 2xl:w-[900px] 2xl:-translate-x-10 2xl:-translate-y-8"></div>
            <div class="relative z-10 flex h-full items-center justify-center rounded-lg border-2 border-black bg-background-light-gray">
              <div class="flex h-full w-full flex-col items-center justify-center gap-4 px-4 md:block md:pt-[60px] lg:pt-[90px] 2xl:p-[10%]">
                <h2 class="left-[50%] whitespace-nowrap text-lg font-bold md:absolute md:-translate-x-[50%] md:tracking-wide lg:-ml-8 lg:text-2xl 2xl:text-3xl">
                  <div class="inline-block">Getting Started With</div>
                  <div class="ml-2 inline-flex w-[80px] justify-center border-b-4 border-mint px-2 md:w-[100px] lg:ml-8 lg:w-[150px] lg:border-b-8 2xl:w-[200px]">
                ...
                <div
                  class={
                    ' left-[50%] top-[130px] w-full md:absolute md:w-[80%] md:-translate-x-[50%] md:p-0 md:px-4 lg:top-[160px] 2xl:top-[180px]'
                  }
                >
