                ...
                <div class="pt-1">
                  <textarea
                    ...
                    class={
                      ...
                      (courseDataError.description ? 'border-tomato dark:border-tomato' : 'border-black/10')
                    }
                  />
                </div>
                <p class="w-[250px] pt-1 tracking-wide text-tomato md:w-[300px]">{courseDataError.description}</p>
              </div>
              <br />
              <button
                onClick$={async () => {
