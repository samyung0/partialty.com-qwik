...
export default component$(({ player }: { player: PlayerAPI }) => {
  ...
  return (
    <button
      type="button"
      class="group relative flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-slate-700 hover:bg-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-700 focus:ring-offset-2 dark:bg-highlight-dark dark:hover:bg-slate-900 md:h-14 md:w-14"
