...
export default component$((props: { user?: LuciaSession['user'] | undefined; disableTheme?: true }) => {
            ...
            <ul class="mx-auto flex w-[90%] flex-col gap-6 py-6">
              <li class="flex items-center gap-6">
                ...
                {login.isLoading ? (
                  ...
                  <div
                    class={' flex -translate-x-[8px] gap-2 sm:translate-x-0' + (!props.disableTheme ? ' ml-auto' : '')}
                  >
                    <span class="relative">
                      <img
            ...
            >
              <div class={'flex gap-2'}>
                <span class="relative">
                  ...
                  />
                  {login.user.role !== 'free' && (
                    <img src={CrownPNG} width={20} height={20} alt="Crown" class="absolute right-[-15px] top-[-15px]" />
                  )}
                </span>
