          ...
          {linkOpen ? (
            <div className="flex flex-col items-stretch rounded-md shadow-sm" role="group">
              ...
              <div className="flex">
                <button
                  ...
                  type="button"
                  className="flex flex-1 justify-center border border-custom-yellow bg-background-light-gray/50 px-4 py-2 text-sm font-medium text-inherit hover:bg-custom-yellow focus:z-10 dark:border-disabled-dark dark:bg-highlight-dark dark:hover:bg-disabled-dark "
                >
                ...
                <button
                  ...
                  type="button"
                  className="flex flex-1 justify-center border-b border-t border-custom-yellow bg-background-light-gray/50 px-4 py-2 text-sm font-medium text-inherit hover:bg-custom-yellow focus:z-10 dark:border-disabled-dark dark:bg-highlight-dark dark:hover:bg-disabled-dark "
                >
            ...
            <div className="inline-flex rounded-md" role="group">
              <button
                ...
                type="button"
                className="rounded-s-lg border border-custom-yellow bg-background-light-gray/50 px-4 py-2 text-sm font-medium text-inherit hover:bg-custom-yellow focus:z-10 dark:border-disabled-dark dark:bg-highlight-dark dark:hover:bg-disabled-dark "
              >
                Edit Link
              </button>
              <button
                ...
                type="button"
                className="rounded-e-lg border border-custom-yellow bg-background-light-gray/50 px-4 py-2 text-sm font-medium text-inherit hover:bg-custom-yellow focus:z-10 dark:border-disabled-dark dark:bg-highlight-dark dark:hover:bg-disabled-dark "
              >
