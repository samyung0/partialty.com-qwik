...
const FormatButton = ({ format, children }: { format: CustomMarkFormat; children: React.ReactNode }) => {
  const editor = useSlate();
  return (
    <button
      className={isMarkActive(editor, format) ? `border-b-2 border-black` : 'border-b-2 border-light-mint'}
