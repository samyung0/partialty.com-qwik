...
export default component$(
  ({
    ...
    return (
      <nav class="h-full max-h-[100vh] w-[20vw] overflow-auto border-r-2 border-yellow bg-light-yellow/50 p-4 text-primary-dark-gray dark:border-disabled-dark dark:bg-primary-dark-gray dark:text-background-light-gray">
        {contentWS.value ? (
