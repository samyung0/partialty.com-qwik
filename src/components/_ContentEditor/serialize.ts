    ...
    case 'infoBlock':
      return `<style>.dark .infoBlock {
        ...
        >
          ...
          <svg class="infoBlockSVG" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="rgb(29 78 216)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5"/><path d="M9 18h6"/><path d="M10 22h4"/></svg>
    ...
    case 'cautionBlock':
      return `<style>.dark .cautionBlock {
        ...
        stroke: rgb(234 179 8) !important;
            ...
            >
              <div style="padding-bottom: 1em;">
              <svg class="cautionBlockSVG" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>
              </div>${children}</blockquote>`;
    ...
    case 'warningBlock':
      return `<style>.dark .warningBlock {
        ...
        stroke: rgb(244 114 182) !important;
                ...
                >
                  <div style="padding-bottom: 1em;">
                  <svg class="warningBlockSVG" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="m15 9-6 6"/><path d="m9 9 6 6"/></svg>
                  </div>${children}</blockquote>`;
